      ...
      <Stack spacing={{ base: 10, md: 20 }} py={{ base: 20, md: 28 }}>
        <Container maxW={"4xl"}>
          <Flex flexDirection={"column"} gap={8}>
            <Box>
              <Center>
                <Heading as="h1"> Privacy Policy for PsySpace Library</Heading>{" "}
              </Center>
            </Box>
            ...
            <Text>
              <UnorderedList>
                ...
                <ListItem>
                  ...
                  Agreement) refers to PsySpace.
                </ListItem>
                <ListItem>
                  Cookies are small files that are placed on Your computer,
                  mobile device or any other device by a 12bsite, containing the
                  details of Your browsing history on that website among its
                  many uses.
                </ListItem>
                <ListItem>Country refers to: Bayern, Germany</ListItem>
                <ListItem>
                ...
                <ListItem>
                  Website refers to PsySpace Library, accessible from
                  <Link href="https://psyspacelibrary.in/">
                    https://psyspacelibrary.in/
                  </Link>
                </ListItem>
                <ListItem>
            ...
            <Text>
              ...
              cookies on the Free Privacy Policy website article. We use both
              Session and Persistent Cookies for the purposes set out below:
            </Text>
            <Heading as="h5">Necessary / Essenstial Cookies</Heading>
            ...
            <Heading as="h5">Functionality Cookies</Heading>
            <Text>Type: Session Cookies</Text>
            <Text>Administered by: Us</Text>
            <Text>
            ...
            <Heading as="h2">Delete Your Personal Data</Heading>
            <Text>
            ...
            <Text>
              ...
              if you have one, and visiting the account settings section that
              allows you to manage Your personal information. You may also
            ...
            <UnorderedList>
              <ListItem>By email: psyspacenetwork@gmail.com</ListItem>
            </UnorderedList>
          </Flex>
        </Container>
      </Stack>
